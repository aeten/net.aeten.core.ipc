...
public enum Errno {
	...
	EOPNOTSUPP, // Operation not supported on socket (POSIX.1) (ENOTSUP and
				// EOPNOTSUPP have the same value on Linux, but according to
	...
	ESTALE, // Stale file handle (POSIX.1) This error can occur for NFS and for
			// other filesystems
	ESTRPIPE, // Streams pipe error
	ETIME, // Timer expired (POSIX.1 (XSI STREAMS option)) (POSIX.1 says
